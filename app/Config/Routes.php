...
$routes->group('', ['filter' => 'auth'], function ($routes) {
    ...
    $routes->post('profile/update_admin_profile/(:any)', 'Profile_HomeController::update_admin_profile/$1');
});


$routes->get('backend/login', 'backend::load_login');
$routes->get('backend/register', 'backend::load_register');
$routes->post('backend/add_admin/(:any)', 'backend/add_admin/$1');
$routes->post('backend/login/(:any)', 'backend/login/$1');
$routes->post('backend/checked_admin/(:any)', 'backend/checked/$1');
