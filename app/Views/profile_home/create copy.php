...
<div class="container d-block d-sm-none d-md-none d-lg-none ">
    ...
    <form id="frmMobile">
        ...
        <div class="row mt-3">
            ...
            <div class="col-12 mt-3">
                <div class="form-floating">
                    <input type="text" name="card_id" id="card_idMobile" class="form-control" placeholder="เลขบัตรประจำตัวประชาชน" />
        ...
        <div class="col-12 mt-3">
            <div class="form-floating">
                <input type="text" name="disease_details" id="disease_detailseMobile" disabled class="form-control"
                     />
        ...
        <div class="col-12 mt-3">
            <div class="form-floating">
                <input type="text" name="caretaker" id="caretakerMobile" disabled class="form-control"
                    placeholder="ผู้ดูแล" />
        ...
        <div class="col-12 mt-3">
            <div class="form-floating">
                <input type="text" name="medicines" id="medicinesMobile" class="form-control"
        ...
        <div class="col-12 mb-3 text-right">
            ...
            <button class="btn btn-primary" type="submit" id="submitBtnMobile">เพิ่มข้อมูล</button>
        </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#submitBtnMobile').on('click', function (e) {
            ...
            const formData = $('#frmMobile').serialize();
